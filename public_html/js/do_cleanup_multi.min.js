...
if(angular)angular.module("app",[]).controller("progress",["$scope","$http","$timeout",function(a,b,d){function e(a){var b="";a=(a/1E3).toFixed(0);var d=a%60;a=(a-d)/60;var e=a%60;(a=(a-e)/60)&&(b=a+" hours, ");if(a||e)b+=e+" minutes, ";return""+b+d+" seconds"}var f,k,h;return c.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return f=new Date,a.lines=[],a.changedTotal=function(){return a.lines.filter(function(a){return a.changed}).length},g.yield(d(),2);if(a.error)return g.return();
