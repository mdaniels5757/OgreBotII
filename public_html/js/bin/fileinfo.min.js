...
d.prototype.asyncExecuteFunction=function(a){f(a,0)};d.prototype.executeBatch_=function(){for(;this.batch_&&this.batch_.length;){var a=this.batch_;this.batch_=[];for(var b=0;b<a.length;++b){var d=a[b];a[b]=null;try{d()}catch(g){this.asyncThrow_(g)}}}this.batch_=null};d.prototype.asyncThrow_=function(a){this.asyncExecuteFunction(function(){throw a;})};b.prototype.createResolveAndReject_=function(){function a(a){return function(l){d||(d=!0,a.call(b,l))}}var b=this,d=!1;return{resolve:a(this.resolveTo_),
...
c.polyfill("Object.is",function(a){return a?a:function(a,d){return a===d?0!==a||1/a===1/d:a!==a&&d!==d}},"es6","es3");c.polyfill("Array.prototype.includes",function(a){return a?a:function(a,d){var b=this;b instanceof String&&(b=String(b));var f=b.length;d=d||0;for(0>d&&(d=Math.max(d+f,0));d<f;d++){var h=b[d];if(h===a||Object.is(h,a))return!0}return!1}},"es7","es3");
c.checkStringArgs=function(a,b,d){if(null==a)throw new TypeError("The 'this' value for String.prototype."+d+" must not be null or undefined");if(b instanceof RegExp)throw new TypeError("First argument to String.prototype."+d+" must not be a regular expression");return a+""};c.polyfill("String.prototype.includes",function(a){return a?a:function(a,d){return-1!==c.checkStringArgs(this,a,"includes").indexOf(a,d||0)}},"es6","es3");
c.iteratorFromArray=function(a,b){c.initSymbolIterator();a instanceof String&&(a+="");var d=0,e={next:function(){if(d<a.length){var f=d++;return{value:b(f,a[f]),done:!1}}e.next=function(){return{done:!0,value:void 0}};return e.next()}};e[Symbol.iterator]=function(){return e};return e};c.polyfill("Array.prototype.keys",function(a){return a?a:function(){return c.iteratorFromArray(this,function(a){return a})}},"es6","es3");(function(){function a(a){return a.match(/^([a-z-]+)\.([a-z-]+)$/).slice(1)}function b(a){var b=f[g.val()];k.html(b.map(function(a){return"<option>"+a+"</option>"})).val(b.includes(a)?a:k.children("option").html()||null)}var d,e,f,h,l,p,k,g;return c.asyncExecutePromiseGeneratorProgram(function(m){if(1==m.nextAddress)return m.yield($.ready,2);d=$("select[name='project']");e=d.attr("class");f={};h=c.makeIterator(a(d.val()));l=h.next().value;p=h.next().value;d.children("option").each(function(){var b=
c.makeIterator(a($(this).html())),d=b.next().value;b=b.next().value;f[b]||(f[b]=[]);f[b].push(d)});k=$("<select/>");g=$("<select/>").append(Object.keys(f).sort().map(function(a){return"<option>"+a+"</option>"})).val(p);g.change(function(){b(k.val())}).change();b(l);d.after($("<div style='display: table-row;'/>").append(g,k),"<input type='hidden' name='project' value='"+d.val()+"' />").remove();d=$("[name='project']");g.add(k).wrap("<div style='display: table-cell'/>").attr("class",e).change(function(){d.val(k.val()+
"."+g.val())});m.jumpToEnd()})})();var n=$("#authordate,#license,#fields"),q=$("#information");q.click(function(){var a=q.is(":checked");a?n.each(function(){$(this).prop("checked",!!this.wasChecked)}):n.each(function(){this.wasChecked=$(this).prop("checked")}).prop("checked",!1);n.prop("disabled",!a)});}).call(this);
