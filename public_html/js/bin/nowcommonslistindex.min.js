...
this.onSettledCallbacks_=null}};var k=new d;b.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};b.prototype.settleSameAsThenable_=function(a,b){var d=this.createResolveAndReject_();try{a.call(b,d.resolve,d.reject)}catch(g){d.reject(g)}};b.prototype.then=function(a,d){function e(a,b){return"function"==typeof a?function(b){try{g(a(b))}catch(m){h(m)}}:b}var g,h,f=new b(function(a,b){g=a;h=b});this.callWhenSettled_(e(a,g),e(d,h));return f};
...
c.iteratorFromArray=function(a,b){c.initSymbolIterator();a instanceof String&&(a+="");var d=0,e={next:function(){if(d<a.length){var f=d++;return{value:b(f,a[f]),done:!1}}e.next=function(){return{done:!0,value:void 0}};return e.next()}};e[Symbol.iterator]=function(){return e};return e};$(function(){$("form").one("submit",function(){$(this).submit(function(){return!1})})});}).call(this);

//# sourceMappingURL=nowcommonslistindex.js.map