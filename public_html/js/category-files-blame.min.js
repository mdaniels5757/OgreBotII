...
$jscomp.asyncExecutePromiseGenerator=function(a){function b(b){return a.next(b)}function c(b){return a.throw(b)}return new Promise(function(e,d){function g(a){a.done?e(a.value):Promise.resolve(a.value).then(b,c).then(g,d)}g(a.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(a){return $jscomp.asyncExecutePromiseGenerator(a())};$jscomp.generator={};
...
$jscomp.generator.Generator_=function(a){this.next=function(b){return a.next_(b)};this.throw=function(b){return a.throw_(b)};this.return=function(b){return a.return_(b)};$jscomp.initSymbolIterator();this[Symbol.iterator]=function(){return this}};$jscomp.generator.createGenerator=function(a,b){$jscomp.generator.Generator_.prototype=a.prototype;return new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(b))};$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};
$jscomp.assign="function"==typeof Object.assign?Object.assign:function(a,b){for(var c=1;c<arguments.length;c++){var e=arguments[c];if(e)for(var d in e)$jscomp.owns(e,d)&&(a[d]=e[d])}return a};$jscomp.polyfill("Object.assign",function(a){return a||$jscomp.assign},"es6","es3");
(function(a){function b(){var b=a.location.search.substring(1),e={};b&&b.split("&").forEach(function(b){var c=$jscomp.makeIterator(b.split("="));b=c.next().value;c=c.next().value;e[b]||(e[b]=a.decodeURIComponent(c))});return e}angular.module("app",[]).controller("ctrl",["$scope","$http","$timeout",function(a,e,d){return $jscomp.asyncExecutePromiseGeneratorFunction(function f(){var c,h,k;return $jscomp.generator.createGenerator(f,function(f){switch(f.nextAddress){case 1:c=b();Object.assign(a,{selectedDate:c.date,
selectedGallery:c.gallery,dates:[],galleries:[],entries:[],limit:100,loadData:function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function l(){function b(){var b=d?k.filter(function(a){return a.gallery===d}):k;a.entries=a.limit?b.slice(0,a.limit):b;a.$digest()}var c,d;return $jscomp.generator.createGenerator(l,function(f){switch(f.nextAddress){case 1:c=a.selectedDate||"";d=a.selectedGallery;if(h===c){b();f.jumpTo(0);break}a.loading=!0;h=c;return f.yield(e({url:"category-files-blame-data.php?date="+
h}).data,3);case 3:k=f.yieldResult,a.loading=!1,a.selectedDate=a.selectedDate||a.dates[0],b(),f.jumpToEnd()}})})}});if(a.selectedDate){a.loadData();f.jumpTo(0);break}return f.yield(d(),3);case 3:a.selectedDate=a.dates[0],a.$digest(),f.jumpToEnd()}})})}]).filter("escape",function(){return function(b){return a.encodeURIComponent(b).replace(/%2F/g,"/").replace(/%3A/g,":").replace(/%20/g,"_")}})})(window); //# sourceMappingURL=js/category-files-blame.js.map
