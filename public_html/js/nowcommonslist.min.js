...
d.polyfill=function(a,b){if(b){var e=d.global;a=a.split(".");for(var f=0;f<a.length-1;f++){var c=a[f];c in e||(e[c]={});e=e[c]}a=a[a.length-1];f=e[a];b=b(f);b!=f&&null!=b&&d.defineProperty(e,a,{configurable:!0,writable:!0,value:b})}};d.FORCE_POLYFILL_PROMISE=!1;
...
d.polyfill("Object.is",function(a){return a?a:function(a,e){return a===e?0!==a||1/a===1/e:a!==a&&e!==e}},"es6","es3");d.polyfill("Array.prototype.includes",function(a){return a?a:function(a,e){var b=this;b instanceof String&&(b=String(b));var c=b.length;e=e||0;for(0>e&&(e=Math.max(e+c,0));e<c;e++){var g=b[e];if(g===a||Object.is(g,a))return!0}return!1}},"es7","es3");
