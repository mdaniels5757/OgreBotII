...
l.prototype.min=function(){return 0},l.prototype.max=function(){return Number.MAX_VALUE},l.prototype.test=function(){},l.getNowCommonsRows=function(a){return c(y).map(function(){var d=new Q(c(this).prev(y).addBack());if(a(d))return d})},E=function(a){var c=l.call(this)||this;c._action=a;return c},$jscomp.inherits(E,l),E.prototype.run=function(){return this._action.run.call(this._action)},E.prototype.test=function(){return this._action.test.call(this._action)},m=function(a){return l.apply(this,arguments)||
this},$jscomp.inherits(m,l),m.prototype.confirm=function(c){return a.confirm("Delete "+c+" files?")},m.prototype._run=function(a){this._markedRun(a)},m.prototype.test=function(){return l.getNowCommonsRows(function(a){return a.selected})},m.prototype.max=function(){return L.val()},m.prototype.postRun=function(){T.close()},r=function(a){return l.apply(this,arguments)||this},$jscomp.inherits(r,l),r.prototype.min=function(){return+Z.val()},r.prototype.max=function(){return+K.val()},r.prototype._run=function(a){this.rows=
a;a.forEach(function(a){a.toggleSelect(!0)})},r.prototype.test=function(){var a=c(x).val().trim().replace(/\n/g,"").trim(),d=f(a),e=c(aa).val().trim().replace(/\n/g,"").trim(),g=f(e),h=z.val().trim(),k=[];if(!a&&!h)throw"Please enter a value into the text box.";h&&k.push(new P(h));a&&k.push(d?new C(d):new D(a.toUpperCase()));e&&(a=g?new C(g):new D(e.toUpperCase()),a.setFilter(function(a){return!a}),k.push(a));c("#include-warnings:checked")[0]||k.push(new v(function(a){return!a.hasWarnings}));c("#include-diff-name:checked")[0]||
k.push(new v(function(a){return!a.hasLinks}));c("#include-multiple:checked")[0]||k.push(new v(function(a){return!a.needsTransfer}));c("#include-talk:checked")[0]||k.push(new v(function(a){return!a.hasTalk}));return l.getNowCommonsRows(function(a){return k.every(function(c){return c.match(a)})})},r.prototype.postRun=function(){U.close()},t=function(a){return m.apply(this,arguments)||this},$jscomp.inherits(t,m),t.prototype._markedRun=function(c){var d=this._getAutoOpenLink.bind(this);c.forEach(function(c){a.open(d(c).attr("href"),
"_blank");c.toggleSelect(!1);e(c.localName)})},R=function(a){return m.apply(this,arguments)||this},$jscomp.inherits(R,m),R.prototype._markedRun=function(a){var d={};a.forEach(function(a){a=c(a.deleteLink);d[a.data(J)]=a.data(ca)});w.text(+w.text()+a.length);O.postMessage(d)},F=function(a){return t.apply(this,arguments)||this},$jscomp.inherits(F,t),F.prototype._getAutoOpenLink=function(a){return a.deleteLink},G=function(a){return t.apply(this,arguments)||this},$jscomp.inherits(G,t),G.prototype.confirm=
function(c){return a.confirm("Delete "+c+" files?")},G.prototype._getAutoOpenLink=function(a){return a.nowCommonsLink},H=new E(new F),c(a).on("beforeunload",function(){var a=c(M).length/2;if(a)return"You have "+a+" selections outstanding"}),da=c(".close-buttons"),z=c("#auto-user"),fa=c(n),S=c(V),w=c(".ajax-count"),Z=c("#auto-mark-start"),K=c("#auto-mark-count"),L=c("#auto-delete-count"),g(),c("#doc-load-per,.ready-count,.bottom-buttons").toggle(),c(ba).click(function(){c(this).closest(y).toggleClass(B)}),
c("#clear-marks").click(function(){c(M).removeClass(B)}),c(".delink,"+ba).click(function(a){a.preventDefault()}),c(x+","+aa).on("keydown paste drop focus",function(){var a=this;setTimeout(function(){var d=c(a);d.toggleClass("regex",!!f(d.val()))},1)}),S.change(function(){H._action=S.is(":checked")?new G:new F}),c(W+","+X).data(A,new r),c(Y+","+I).data(A,H),c(Y+","+W).click(function(){try{c(this).data(A).run()}catch(u){a.alert(u)}}),c(X+","+I).click(function(){try{c("#count").html(c(this).data(A).test().length),
ea.open()}catch(u){a.alert(u)}}),da.click(function(){c(".bottom-buttons-buttons > *").animate({width:"toggle"},350);da.toggleClass("glyphicon-menu-left")}),ea=new N("#auto-files-found"),ea.addCloseButton("#auto-delete-found-ok"),T=new N(k,{open:function(){var a=H.test().length;L.val(a).attr("max",a)}}),T.addOpenButton("#auto-delete-open"),T.addCloseButton("#auto-delete-cancel"),U=new N(h),U.addOpenButton(h+"-open"),U.addCloseButton(h+"-cancel"),d.setCatchFinallyBlocks(3),d.yield(O.ready(),5);case 5:w.text(0);
a.topBar({css:{background:"#000099"},message:"Ajax delete detected"});H._action=new R;S.closest(".table-row").hide();O.addListener(function(c){w.text(w.text()-1);"success"===c.status?(a.topBar({css:{background:"#009999"},delay:2E3,message:c.page+": deleted"}),e(c.page)):a.topBar(c.page+": "+c.message)});d.leaveTryBlock(0);break;case 3:d.enterCatchBlock(),a.topBar({css:{background:"#990000"},message:"Ajax detection failed"}),d.jumpToEnd()}})})})(window);
