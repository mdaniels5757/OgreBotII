...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var g=new b;f.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};f.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(n){c.reject(n)}};f.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(x){e(x)}}:b}var d,e,m=new f(function(a,
...
z.val();z.html("").append("<option/>").append(Array.from(new Set(l.getNowCommonsRows(function(){return!0}).get().map(function(a){return a.uploaders})._flatten())).sort().map(function(a){return c("<option/>").val(a).text(a)[0]}));z.val(a)}var c,m,h,n,V,Y,I,W,X,x,aa,ha,ba,A,J,y,ca,B,M,N,O,p,P,v,q,C,D,Q,l,E,k,r,t,R,F,G,H,da,z,fa,S,w,Z,K,L,ea,T,U;return $jscomp.generator.createGenerator(d,function(d){switch(d.nextAddress){case 1:return c=a.$,m="#auto-delete",h="#auto-mark",n=m+"-remove-deleted",V=m+"-nc",
Y=m+"-ok",I=m+"-test",W=h+"-ok",X=h+"-test",x=h+"-text",aa=h+"-text-omit",ha=".delete",ba=".mark-auto",A="ncAction",J="name",y=".nc-row",ca="reason",B="selected",M="."+B,N=a.MDialog,O=new a.XDomain,a.setIntervalImmediate(function(){c("#ready-count").html(Math.floor(c("input.file").length/c("#files-count").val()*100));return!c.isReady}),d.yield(c.ready,2);case 2:return p=function(){},p.prototype.match=function(){},P=function(a){var c=p.call(this)||this;c._user=a;return c},$jscomp.inherits(P,p),P.prototype.match=
...
l.prototype.min=function(){return 0},l.prototype.max=function(){return Number.MAX_VALUE},l.prototype.test=function(){},l.getNowCommonsRows=function(a){return c(y).map(function(){var d=new Q(c(this).prev(y).addBack());if(a(d))return d})},E=function(a){var c=l.call(this)||this;c._action=a;return c},$jscomp.inherits(E,l),E.prototype.run=function(){return this._action.run.call(this._action)},E.prototype.test=function(){return this._action.test.call(this._action)},k=function(a){return l.apply(this,arguments)||
this},$jscomp.inherits(k,l),k.prototype.confirm=function(c){return a.confirm("Delete "+c+" files?")},k.prototype._run=function(a){this._markedRun(a)},k.prototype.test=function(){return l.getNowCommonsRows(function(a){return a.selected})},k.prototype.max=function(){return L.val()},k.prototype.postRun=function(){T.close()},r=function(a){return l.apply(this,arguments)||this},$jscomp.inherits(r,l),r.prototype.min=function(){return+Z.val()},r.prototype.max=function(){return+K.val()},r.prototype._run=function(a){this.rows=
...
k.push(new v(function(a){return!a.hasLinks}));c("#include-multiple:checked")[0]||k.push(new v(function(a){return!a.needsTransfer}));c("#include-talk:checked")[0]||k.push(new v(function(a){return!a.hasTalk}));return l.getNowCommonsRows(function(a){return k.every(function(c){return c.match(a)})})},r.prototype.postRun=function(){U.close()},t=function(a){return k.apply(this,arguments)||this},$jscomp.inherits(t,k),t.prototype._markedRun=function(c){var d=this._getAutoOpenLink.bind(this);c.forEach(function(c){a.open(d(c).attr("href"),
"_blank");c.toggleSelect(!1)})},t.prototype.postRun=function(a){a.forEach(function(a){return e(a.localName)});k.prototype.postRun.call(this)},R=function(a){return k.apply(this,arguments)||this},$jscomp.inherits(R,k),R.prototype._markedRun=function(a){var d={};a.forEach(function(a){a=c(a.deleteLink);d[a.data(J)]=a.data(ca)});w.text(+w.text()+a.length);O.postMessage(d)},F=function(a){return t.apply(this,arguments)||this},$jscomp.inherits(F,t),F.prototype._getAutoOpenLink=function(a){return a.deleteLink},
G=function(a){return t.apply(this,arguments)||this},$jscomp.inherits(G,t),G.prototype.confirm=function(c){return a.confirm("Delete "+c+" files?")},G.prototype._getAutoOpenLink=function(a){return a.nowCommonsLink},H=new E(new F),c(a).on("beforeunload",function(){var a=c(M).length/2;if(a)return"You have "+a+" selections outstanding"}),da=c(".close-buttons"),z=c("#auto-user"),fa=c(n),S=c(V),w=c(".ajax-count"),Z=c("#auto-mark-start"),K=c("#auto-mark-count"),L=c("#auto-delete-count"),g(),c("#doc-load-per,.ready-count,.bottom-buttons").toggle(),
...
d.jumpToEnd()}})})})(window); //# sourceMappingURL=js/nowcommonslist.js.map
