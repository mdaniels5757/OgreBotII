...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var g=new b;f.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};f.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(n){c.reject(n)}};f.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(x){e(x)}}:b}var d,e,k=new f(function(a,
b){d=a;e=b});this.callWhenSettled_(c(a,d),c(b,e));return k};f.prototype.catch=function(a){return this.then(void 0,a)};f.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case 1:a(d.result_);break;case 2:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?g.asyncExecute(c):this.onSettledCallbacks_.push(function(){g.asyncExecute(c)})};f.resolve=d;f.reject=function(a){return new f(function(b,c){c(a)})};f.race=function(a){return new f(function(b,
...
$jscomp.polyfill("WeakMap",function(a){function b(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),c=Object.seal({}),d=new a([[b,2],[c,3]]);if(2!=d.get(b)||3!=d.get(c))return!1;d.delete(b);d.set(c,4);return!d.has(b)&&4==d.get(c)}catch(V){return!1}}function d(a){$jscomp.owns(a,f)||$jscomp.defineProperty(a,f,{value:{}})}function e(a){var b=Object[a];b&&(Object[a]=function(a){d(a);return b(a)})}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(b())return a;
...
c||"function"==c?d.has(b)?c=d.get(b):(c=""+ ++k,d.set(b,c)):c="p_"+b;var e=a.data_[c];if(e&&$jscomp.owns(a.data_,c))for(a=0;a<e.length;a++){var f=e[a];if(b!==b&&f.key!==f.key||b===f.key)return{id:c,list:e,index:a,entry:f}}return{id:c,list:e,index:-1,entry:void 0}},g=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},c=function(){var a={};return a.previous=
a.next=a.head=a},k=0;return e},"es6","es3");
$jscomp.polyfill("Set",function(a){function b(){if($jscomp.ASSUME_NO_NATIVE_SET||!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var b=Object.seal({x:4}),d=new a($jscomp.makeIterator([b]));if(!d.has(b)||1!=d.size||d.add(b)!=d||1!=d.size||d.add({x:4})!=d||2!=d.size)return!1;var g=d.entries(),c=g.next();if(c.done||c.value[0]!=b||c.value[1]!=b)return!1;c=g.next();return c.done||c.value[0]==b||4!=c.value[0].x||c.value[1]!=c.value[0]?!1:g.next().done}catch(k){return!1}}
...
(function(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function d(){function e(a){fa.is(":checked")&&(c("a.delete").get().forEach(function(d){d=c(d);if(d.data(J)===a){d.closest(y).prev().addBack().remove();var u=+K.attr("max")-1;[L,K,Z].forEach(function(a){a=c(a);a.attr("max",u).val(Math.min(+a.val(),u))})}}),g())}function f(a){var c=a.lastIndexOf("/");if(0>a.indexOf("\n")&&a.match(/^\/.*?\/[mi]*$/))try{return new RegExp(a.substring(1,c),a.substring(c+1))}catch(ia){}}function g(){var a=
z.val();z.html("").append("<option/>").append(Array.from(new Set(l.getNowCommonsRows(function(){return!0}).get().map(function(a){return a.uploaders})._flatten())).sort().map(function(a){return c("<option/>").val(a).text(a)[0]}));z.val(a)}var c,k,h,n,V,Y,I,W,X,x,aa,ha,ba,A,J,y,ca,B,M,N,O,p,P,v,q,C,D,Q,l,E,m,r,t,R,F,G,H,da,z,fa,S,w,Z,K,L,ea,T,U;return $jscomp.generator.createGenerator(d,function(d){switch(d.nextAddress){case 1:return c=a.$,k="#auto-delete",h="#auto-mark",n=k+"-remove-deleted",V=k+"-nc",
Y=k+"-ok",I=k+"-test",W=h+"-ok",X=h+"-test",x=h+"-text",aa=h+"-text-omit",ha=".delete",ba=".mark-auto",A="ncAction",J="name",y=".nc-row",ca="reason",B="selected",M="."+B,N=a.MDialog,O=new a.XDomain,a.setIntervalImmediate(function(){c("#ready-count").html(Math.floor(c("input.file").length/c("#files-count").val()*100));return!c.isReady}),d.yield(c.ready,2);case 2:return p=function(){},p.prototype.match=function(){},P=function(a){var c=p.call(this)||this;c._user=a;return c},$jscomp.inherits(P,p),P.prototype.match=
function(a){return a.uploaders.includes(this._user)},v=function(a){var c=p.call(this)||this;c.match=a;return c},$jscomp.inherits(v,p),q=function(){var a=p.call(this)||this;a.__matchOne=a._matchOne.bind(a);return a},$jscomp.inherits(q,p),q.prototype.match=function(a){a=a.texts.some(this.__matchOne);this._filter&&(a=this._filter(a));return a},q.prototype.setFilter=function(a){this._filter=a},C=function(a){var c=q.call(this)||this;c._regex=a;return c},$jscomp.inherits(C,q),C.prototype._matchOne=function(a){return a.match(this._regex)},
D=function(a){var c=q.call(this)||this;c._needle=a;return c},$jscomp.inherits(D,q),D.prototype._matchOne=function(a){return-1<a.toUpperCase().indexOf(this._needle)},Q=function(a){this._div=a;this.texts=c(".text",a).get().map(function(a){return c(a).text()});this.deleteLink=c(ha,a)},Q.prototype.toggleSelect=function(a){this._div.toggleClass(B,a)},$jscomp.global.Object.defineProperties(Q.prototype,{deleteReason:{configurable:!0,enumerable:!0,get:function(){return this.deleteLink.data(ca)}},localName:{configurable:!0,
enumerable:!0,get:function(){return this.deleteLink.data(J)}},nowCommonsLink:{configurable:!0,enumerable:!0,get:function(){return c(".nowcommons",this._div)}},selected:{configurable:!0,enumerable:!0,get:function(){return this._div.is(M)}},hasWarnings:{configurable:!0,enumerable:!0,get:function(){return c(".mark-problematic,.mark-keeplocal,.error-warning",this._div)[0]}},hasLinks:{configurable:!0,enumerable:!0,get:function(){return c(".linkback",this._div)[0]}},needsTransfer:{configurable:!0,enumerable:!0,
get:function(){return c(".oldver",this._div)[0]}},hasTalk:{configurable:!0,enumerable:!0,get:function(){return c(".talk",this._div)[0]}},uploaders:{configurable:!0,enumerable:!0,get:function(){return c(".user",this._div).get().map(function(a){return c(a).text()})}}}),l=function(){},l.prototype._run=function(){},l.prototype.run=function(){var a=this.test().get().slice(this.min(),this.max());this.confirm(a.length)&&(this._run(a),a.forEach(function(a){return e(a.localName)}));this.postRun()},l.prototype.postRun=
function(){},l.prototype.confirm=function(){return!0},l.prototype.min=function(){return 0},l.prototype.max=function(){return Number.MAX_VALUE},l.prototype.test=function(){},l.getNowCommonsRows=function(a){return c(y).map(function(){var d=new Q(c(this).prev(y).addBack());if(a(d))return d})},E=function(a){var c=l.call(this)||this;c._action=a;return c},$jscomp.inherits(E,l),E.prototype.run=function(){return this._action.run.call(this._action)},E.prototype.test=function(){return this._action.test.call(this._action)},
m=function(a){return l.apply(this,arguments)||this},$jscomp.inherits(m,l),m.prototype.confirm=function(c){return a.confirm("Delete "+c+" files?")},m.prototype._run=function(a){this._markedRun(a)},m.prototype.test=function(){return l.getNowCommonsRows(function(a){return a.selected})},m.prototype.max=function(){return L.val()},m.prototype.postRun=function(){T.close()},r=function(a){return l.apply(this,arguments)||this},$jscomp.inherits(r,l),r.prototype.min=function(){return+Z.val()},r.prototype.max=
function(){return+K.val()},r.prototype._run=function(a){this.rows=a;a.forEach(function(a){a.toggleSelect(!0)})},r.prototype.test=function(){var a=c(x).val().trim().replace(/\n/g,"").trim(),d=f(a),e=c(aa).val().trim().replace(/\n/g,"").trim(),g=f(e),h=z.val().trim(),k=[];if(!a&&!h)throw"Please enter a value into the text box.";h&&k.push(new P(h));a&&k.push(d?new C(d):new D(a.toUpperCase()));e&&(a=g?new C(g):new D(e.toUpperCase()),a.setFilter(function(a){return!a}),k.push(a));c("#include-warnings:checked")[0]||
k.push(new v(function(a){return!a.hasWarnings}));c("#include-diff-name:checked")[0]||k.push(new v(function(a){return!a.hasLinks}));c("#include-multiple:checked")[0]||k.push(new v(function(a){return!a.needsTransfer}));c("#include-talk:checked")[0]||k.push(new v(function(a){return!a.hasTalk}));return l.getNowCommonsRows(function(a){return k.every(function(c){return c.match(a)})})},r.prototype.postRun=function(){U.close()},t=function(a){return m.apply(this,arguments)||this},$jscomp.inherits(t,m),t.prototype._markedRun=
function(c){var d=this._getAutoOpenLink.bind(this);c.forEach(function(c){a.open(d(c).attr("href"),"_blank");c.toggleSelect(!1)})},R=function(a){return m.apply(this,arguments)||this},$jscomp.inherits(R,m),R.prototype._markedRun=function(a){var d={};a.forEach(function(a){a=c(a.deleteLink);d[a.data(J)]=a.data(ca)});w.text(+w.text()+a.length);O.postMessage(d)},F=function(a){return t.apply(this,arguments)||this},$jscomp.inherits(F,t),F.prototype._getAutoOpenLink=function(a){return a.deleteLink},G=function(a){return t.apply(this,
arguments)||this},$jscomp.inherits(G,t),G.prototype.confirm=function(c){return a.confirm("Delete "+c+" files?")},G.prototype._getAutoOpenLink=function(a){return a.nowCommonsLink},H=new E(new F),c(a).on("beforeunload",function(){var a=c(M).length/2;if(a)return"You have "+a+" selections outstanding"}),da=c(".close-buttons"),z=c("#auto-user"),fa=c(n),S=c(V),w=c(".ajax-count"),Z=c("#auto-mark-start"),K=c("#auto-mark-count"),L=c("#auto-delete-count"),g(),c("#doc-load-per,.ready-count,.bottom-buttons").toggle(),
c(ba).click(function(){c(this).closest(y).toggleClass(B)}),c("#clear-marks").click(function(){c(M).removeClass(B)}),c(".delink,"+ba).click(function(a){a.preventDefault()}),c(x+","+aa).on("keydown paste drop focus",function(){var a=this;setTimeout(function(){var d=c(a);d.toggleClass("regex",!!f(d.val()))},1)}),S.change(function(){H._action=S.is(":checked")?new G:new F}),c(W+","+X).data(A,new r),c(Y+","+I).data(A,H),c(Y+","+W).click(function(){try{c(this).data(A).run()}catch(u){a.alert(u)}}),c(X+","+
I).click(function(){try{c("#count").html(c(this).data(A).test().length),ea.open()}catch(u){a.alert(u)}}),da.click(function(){c(".bottom-buttons-buttons > *").animate({width:"toggle"},350);da.toggleClass("glyphicon-menu-left")}),ea=new N("#auto-files-found"),ea.addCloseButton("#auto-delete-found-ok"),T=new N(k,{open:function(){var a=H.test().length;L.val(a).attr("max",a)}}),T.addOpenButton("#auto-delete-open"),T.addCloseButton("#auto-delete-cancel"),U=new N(h),U.addOpenButton(h+"-open"),U.addCloseButton(h+
"-cancel"),d.setCatchFinallyBlocks(3),d.yield(O.ready(),5);case 5:w.text(0);a.topBar({css:{background:"#000099"},message:"Ajax delete detected"});H._action=new R;S.closest(".table-row").hide();O.addListener(function(c){w.text(w.text()-1);"success"===c.status?(a.topBar({css:{background:"#009999"},delay:2E3,message:c.page+": deleted"}),e(c.page)):a.topBar(c.page+": "+c.message)});d.leaveTryBlock(0);break;case 3:d.enterCatchBlock(),a.topBar({css:{background:"#990000"},message:"Ajax detection failed"}),
d.jumpToEnd()}})})})(window);
