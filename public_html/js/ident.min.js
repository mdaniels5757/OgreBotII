...
this.onSettledCallbacks_=null}};var h=new d;b.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};b.prototype.settleSameAsThenable_=function(a,b){var d=this.createResolveAndReject_();try{a.call(b,d.resolve,d.reject)}catch(m){d.reject(m)}};b.prototype.then=function(a,d){function g(a,b){return"function"==typeof a?function(b){try{e(a(b))}catch(q){k(q)}}:b}var e,k,f=new b(function(a,b){e=a;k=b});this.callWhenSettled_(g(a,e),g(d,k));return f};
...
d)})};b.all=function(a){var d=c.makeIterator(a),g=d.next();return g.done?e([]):new b(function(a,b){function f(b){return function(d){k[b]=d;h--;0==h&&a(k)}}var k=[],h=0;do k.push(void 0),h++,e(g.value).callWhenSettled_(f(k.length-1),b),g=d.next();while(!g.done)})};return b},"es6","es3");c.SYMBOL_PREFIX="jscomp_symbol_";c.initSymbol=function(){c.initSymbol=function(){};c.global.Symbol||(c.global.Symbol=c.Symbol)};c.Symbol=function(){var a=0;return function(b){return c.SYMBOL_PREFIX+(b||"")+a++}}();
...
angular.module("app",["ngCookies"]).controller("ctrl",["$scope","$http","$log","$interval","$cookies",function(a,b,d,e,f){function h(b){r&&n.postMessage({state:b,cookie:a.cookie},location.origin)}angular.extend(a,{authorize:function(){var d,e;return c.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return a.ajax=!0,g.yield(b({url:"authorize.php"}),2);d=g.yieldResult;e=d.data.redirect;a.ajax=!1;e&&(p.href=e);g.jumpToEnd()})},logout:function(){var d;return c.asyncExecutePromiseGeneratorProgram(function(e){if(1==
e.nextAddress)return a.ajax=!0,e.yield(b({url:"logout.php"}),2);d=e.yieldResult;a.ajax=!1;d.data.success&&(a.username=a.cookie=null);e.jumpToEnd()})},open:function(){window.open(location.pathname,"_blank")}});a.cookie=f.get("magog-ident");e(function(){var b=f.get("magog-ident");b!==a.cookie&&(a.username=null,a.cookie=b,h("update"))},2E3);window.onmessage=function(a){var b=a.origin;b!==location.origin?d.error("Bad origin: "+b+" != "+location.origin):(r=(a.data||{}).watch)&&h("initial")}}]).filter("escape",
