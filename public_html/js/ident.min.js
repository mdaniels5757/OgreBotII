...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var g=new b;c.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};c.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};c.prototype.then=function(a,b){function d(a,b){return"function"==typeof a?function(b){try{f(a(b))}catch(r){e(r)}}:b}var f,e,l=new c(function(a,
b){f=a;e=b});this.callWhenSettled_(d(a,f),d(b,e));return l};c.prototype.catch=function(a){return this.then(void 0,a)};c.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case 1:a(d.result_);break;case 2:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?g.asyncExecute(c):this.onSettledCallbacks_.push(function(){g.asyncExecute(c)})};c.resolve=d;c.reject=function(a){return new c(function(b,c){c(a)})};c.race=function(a){return new c(function(b,
c){for(var e=$jscomp.makeIterator(a),f=e.next();!f.done;f=e.next())d(f.value).callWhenSettled_(b,c)})};c.all=function(a){var b=$jscomp.makeIterator(a),e=b.next();return e.done?d([]):new c(function(a,c){function f(b){return function(c){m[b]=c;g--;0==g&&a(m)}}var m=[],g=0;do m.push(void 0),g++,d(e.value).callWhenSettled_(f(m.length-1),c),e=b.next();while(!e.done)})};return c},"es6","es3");
$jscomp.asyncExecutePromiseGenerator=function(a){function b(b){return a.next(b)}function d(b){return a.throw(b)}return new Promise(function(e,c){function g(a){a.done?e(a.value):Promise.resolve(a.value).then(b,d).then(g,c)}g(a.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(a){return $jscomp.asyncExecutePromiseGenerator(a())};$jscomp.generator={};
...
(function(a){var b=a.angular,d=a.top,e=d.location,c=a.location,g;c.pathname.endsWith("/complete.php")&&a.history.pushState("","","start.php");b.module("app",["ngCookies"]).controller("ctrl",["$scope","$http","$log","$interval","$cookies",function(f,l,h,k,p){function q(a){g&&d.postMessage({state:a,cookie:f.cookie},c.origin)}b.extend(f,{authorize:function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function n(){var a,b;return $jscomp.generator.createGenerator(n,function(c){switch(c.nextAddress){case 1:return f.ajax=
!0,c.yield(l({url:"authorize.php"}),2);case 2:a=c.yieldResult,b=a.data.redirect,f.ajax=!1,b&&(e.href=b),c.jumpToEnd()}})})},logout:function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function n(){var a;return $jscomp.generator.createGenerator(n,function(b){switch(b.nextAddress){case 1:return f.ajax=!0,b.yield(l({url:"logout.php"}),2);case 2:a=b.yieldResult,f.ajax=!1,a.data.success&&(f.username=f.cookie=null),b.jumpToEnd()}})})},open:function(){a.open(c.pathname,"_blank")}});f.cookie=p.get("magog-ident");
k(function(){var a=p.get("magog-ident");a!==f.cookie&&(f.username=null,f.cookie=a,q("update"))},2E3);a.onmessage=function(a){var b=a.origin;b!==c.origin?h.error("Bad origin: "+b+" != "+c.origin):(g=(a.data||{}).watch)&&q("initial")}}]).filter("escape",function(){return function(b){return a.encodeURIComponent(b).replace(/%2F/g,"/").replace(/%3A/g,":").replace(/%20/g,"_")}})})(window); //# sourceMappingURL=js/ident.js.map
