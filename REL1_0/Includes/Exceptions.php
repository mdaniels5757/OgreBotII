...
/**
 *
 * @author Magog the Ogre 2014/02/09
 * @package Exceptions
 */
class EditConflictException extends Exception {
	private $originalText;
	public function __construct($originalText, $error = null) {
		global $validator;
		parent::__construct(
				"EditConflictException: " . $error
		);
		
		$validator->validate_arg($originalText, "string");
